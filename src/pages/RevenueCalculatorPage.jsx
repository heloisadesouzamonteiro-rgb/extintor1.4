...
const calculatorBenefits = [
  "Veja seu potencial anual em segundos",
  "Descubra a media mensal da operacao",
  "Entenda o impacto de crescer 10%",
];
...
export default function RevenueCalculatorPage() {
  ...
  useEffect(() => {
    ...
    const description =
      "Preencha seus dados, libere a calculadora e descubra o potencial de faturamento da sua empresa de extintores.";
  ...
  async function handleLeadSubmit(event) {
    ...
    try {
      ...
      const rawMessage = error instanceof Error ? error.message : "Nao foi possivel liberar a calculadora agora.";
  ...
  async function handleResultSubmit() {
    if (!savedLead?.id) {
      setResultError("Libere a calculadora antes de gerar o resultado.");
      return;
    }
      ...
      <main className="calculator-main">
        <section className="calculator-hero">
          <div className="calculator-hero__copy">
            ...
            <h1>Descubra o potencial de faturamento da sua empresa de extintores</h1>
            <p>Preencha seus dados para liberar gratuitamente a calculadora.</p>

            <div className="calculator-benefit-list" aria-label="Beneficios da simulacao">
              {calculatorBenefits.map((benefit) => (
                <div key={benefit} className="calculator-benefit-list__item">
                  <CheckIcon />
                  <span>{benefit}</span>
                </div>
              ))}
            ...
            {!leadUnlocked ? (
              <form className="lead-capture-card" onSubmit={handleLeadSubmit}>
                <div className="lead-capture-card__header">
                  ...
                  <h2>Liberar calculadora gratis</h2>
                  <p>Preencha seus dados e receba acesso imediato a simulacao.</p>
                </div>
                ...
                <button type="submit" className="calculator-primary-button calculator-primary-button--full" disabled={leadSaving}>
                  {leadSaving ? "Liberando..." : "Liberar calculadora gratis"}
                </button>
              </form>
            ) : (
              <div className="lead-success-card">
                <span className="calculator-pill">Calculadora liberada</span>
                <h2>Pronto, {savedLead?.name?.split(" ")[0] || "seu acesso"} foi liberado.</h2>
                <p>Agora preencha os dados da carteira para ver o potencial comercial da sua operacao.</p>
          ...
          <section className="calculator-workspace">
            <div className="calculator-workspace__header">
              <div>
                ...
                <p>Preencha os dados abaixo e veja uma estimativa comercial da sua operacao.</p>
              </div>
            </div>
            ...
            <div className="calculator-workspace__grid">
              <form className="calculator-form-card" onSubmit={(event) => event.preventDefault()}>
                ...
                <small className="calculator-note">
                  Preencha so o basico para ver uma estimativa rapida. Os ajustes avancados sao opcionais.
                </small>
                ...
                <button type="button" className="calculator-primary-button calculator-primary-button--full" onClick={handleResultSubmit} disabled={resultSaving}>
                  {resultSaving ? "Salvando resultado..." : "Ver resultado"}
                </button>
              </form>
